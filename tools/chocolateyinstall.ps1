...
$url64      = 'https://github.com/axonops/axonops-workbench-cassandra/releases/download/0.1.0-internal-20240801-brew/AxonOpsWorkbench-0.1.0-internal-20240801-brew-win-x64.exe'
