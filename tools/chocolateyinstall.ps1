...
$url64      = 'https://github.com/axonops/axonops-workbench-cassandra/releases/download/0.1.0-internal-20240729/AxonOpsWorkbench-0.1.0-internal-20240729-win-x64.exe' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
